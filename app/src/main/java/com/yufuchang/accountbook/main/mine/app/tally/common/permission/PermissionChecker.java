package com.yufuchang.accountbook.main.mine.app.tally.common.permission;
...
import com.yufuchang.accountbook.base.utils.FitUtils;
...
/**
 * @author : liuchao
 * created on 2019/4/29 7:39 PM
 * description : https://github.com/jokermonn/permissions4m/blob/master/permissions4m-api/src/main/java/com/joker/api/apply/PermissionsChecker.java
 */
...
//    }
     ...
     * @return true if success
     */
    private static boolean checkLocation(Activity activity) throws SecurityException {
        granted = false;
     ...
     * <p>
     * in {@link FitUtils.Brand#XIAO_MI} or
     * {@link FitUtils.Brand#OPPO}          :
     * -> {@link TelephonyManager#getDeviceId()} will be null if deny permission
     * <p>
     * in {@link FitUtils.Brand#MEI_ZU}     :
     * -> {@link TelephonyManager#getSubscriberId()} will be null if deny permission
     *
     * @return true if success
     */
    @SuppressLint("HardwareIds")
    private static boolean checkReadPhoneState(Activity activity) throws SecurityException {
    ...
    /**
     * in {@link FitUtils.Brand#XIAO_MI}
    ...
    /**
     * 是否需要通过执行危险代码来判断是否获取了权限
     */
    private static boolean needCheckByRunDangerousCode() {
        FitUtils.Brand brand = FitUtils.getBrand();
        return brand == FitUtils.Brand.HUAWEI || brand == FitUtils.Brand.XIAO_MI || brand == FitUtils.Brand.MEI_ZU;
    }
}

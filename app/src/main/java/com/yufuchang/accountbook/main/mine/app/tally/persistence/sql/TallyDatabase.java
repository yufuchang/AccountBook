package com.yufuchang.accountbook.main.mine.app.tally.persistence.sql;
...
import com.yufuchang.accountbook.main.mine.app.tally.data.CategoryContant;
...
public abstract class TallyDatabase extends RoomDatabase {
    /** sqlite db name */
    private static final String DATABASE_NAME = "sql_worker";
    ...
    private static Callback mTallDatabaseCallback = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            Context context = WorkerApp.getAppContext();

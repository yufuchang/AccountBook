...
import com.yufuchang.accountbook.main.mine.app.tally.module.chart.widget.MarkerViewDailyData;
import com.yufuchang.accountbook.main.mine.app.tally.module.chart.widget.MarkerViewMonthData;
import com.yufuchang.accountbook.main.mine.app.tally.module.chart.widget.MineBarChart;
import com.yufuchang.accountbook.main.mine.app.tally.module.chart.widget.MineLineChart;
import com.yufuchang.accountbook.main.mine.app.tally.module.chart.widget.MinePieChart;
...
import com.yufuchang.accountbook.tally.module.chart.TallyChartActivityBinding;
...
public class TallyChartActivity extends BaseActivity {
    ...
    private final int[] categoryExpenseColorArray = new int[]{
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor1),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor2),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor3),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor4),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor5),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor6),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor7),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryExpenseColor9)
    };
    private final int[] categoryIncomeColorArray = new int[]{
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor1),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor2),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor3),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor4),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor5),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor6),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor7),
            ResUtils.getColor(WorkerApp.getAppContext(), R.color.categoryIncomeColor9)
    };
...
//        mPieChart.animateY(1400, Easing.EasingOption.EaseInOutQuart);
        mPieChart.animateY(1400, Easing.EaseInOutQuart);
    }
}

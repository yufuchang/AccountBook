package com.yufuchang.accountbook.base.cache;
...
import static com.yufuchang.accountbook.base.utils.LogUtils.LOGE;
...
public class Cache {
    ...
    /** 缓存文件夹名称 */
    private static String CACHE_FOLDER_NAME = "WorkerApp";
